...
public class WatWriter {
    ...
    /**
     * Construct a new {@link WatWriter} that writes to the given {@link PrintStream}.
     *
     * @param ps The stream to write to.
     */
    public WatWriter(PrintStream ps) {
        this.ps = ps;
    }
    ...
    public static String writeToString(Object obj) {
        ...
        new WatWriter(new PrintStream(baos)).write(obj);
     ...
     * <p>
     * The object will be written as an s-expression, as read by {@link WatReader}.
     * <p>
     * Note that not all objects can be {@link WatReader#readAll(CharSequence) read} back after writing,
     * only those that {@link WatReader read} supports. Notably, anything returned by {@link WatReader#readAll(CharSequence)}
